...
local darkness = UnitCastingInfo("boss1") == "黑暗降临"
...
if e.mounted or chatFrame or e.dead or e.travel or e.catStealth or darkness then
    Wa1Key.Prop.Go = 255
    return true
end
...
if e.healingClass[e.specID] and e.inParty then
    Wa1Key.Prop.Go = 1
    return true
end
