...
function fu.GetBlockIndexByClassIDAndSpecIndex(classID, specIndex)
    ...
    if classID == 11 then -- 德鲁伊
        ...
        macroList = {
            { "s1", "CTRL-NUMPAD1", "/cast [group:raid,@raid1]回春术;[group:party,@player]回春术" },
            { "s2", "CTRL-NUMPAD2", "/cast [group:raid,@raid2]回春术;[group:party,@party1]回春术" },
            { "s3", "CTRL-NUMPAD3", "/cast [group:raid,@raid3]回春术;[group:party,@party2]回春术" },
            { "s4", "CTRL-NUMPAD4", "/cast [group:raid,@raid4]回春术;[group:party,@party3]回春术" },
            { "s5", "CTRL-NUMPAD5", "/cast [group:raid,@raid5]回春术;[group:party,@party4]回春术" },
            { "s6", "CTRL-NUMPAD6", "/cast [group:raid,@raid6]回春术" },
            { "s7", "CTRL-NUMPAD7", "/cast [group:raid,@raid7]回春术" },
            { "s8", "CTRL-NUMPAD8", "/cast [group:raid,@raid8]回春术" },
            { "s9", "CTRL-NUMPAD9", "/cast [group:raid,@raid9]回春术" },
            { "s10", "CTRL-NUMPAD0", "/cast [group:raid,@raid10]回春术" },
            { "s11", "CTRL-NUMPADDECIMAL", "/cast [group:raid,@raid11]回春术" },
            { "s12", "CTRL-NUMPADPLUS", "/cast [group:raid,@raid12]回春术" },
            { "s13", "CTRL-NUMPADMINUS", "/cast [group:raid,@raid13]回春术" },
            { "s14", "CTRL-NUMPADMULTIPLY", "/cast [group:raid,@raid14]回春术" },
            { "s15", "CTRL-NUMPADDIVIDE", "/cast [group:raid,@raid15]回春术" },
            { "s16", "CTRL-F1", "/cast [group:raid,@raid16]回春术" },
            { "s17", "CTRL-F2", "/cast [group:raid,@raid17]回春术" },
            { "s18", "CTRL-F3", "/cast [group:raid,@raid18]回春术" },
            { "s19", "CTRL-F5", "/cast [group:raid,@raid19]回春术" },
            { "s20", "CTRL-F6", "/cast [group:raid,@raid20]回春术" },
            { "s21", "CTRL-F7", "/cast [group:raid,@raid21]回春术" },
            { "s22", "CTRL-F8", "/cast [group:raid,@raid22]回春术" },
            { "s23", "CTRL-F9", "/cast [group:raid,@raid23]回春术" },
            { "s24", "CTRL-F10", "/cast [group:raid,@raid24]回春术" },
            { "s25", "CTRL-F11", "/cast [group:raid,@raid25]回春术" },
            { "s26", "CTRL-F12", "/cast [group:raid,@raid26]回春术" },
            { "s27", "CTRL-,", "/cast [group:raid,@raid27]回春术" },
            { "s28", "CTRL-.", "/cast [group:raid,@raid28]回春术" },
            { "s29", "CTRL-/", "/cast [group:raid,@raid29]回春术" },
            { "s30", "CTRL-;", "/cast [group:raid,@raid30]回春术" },
            { "s31", "CTRL-'", "/cast [group:raid,@raid1]愈合;[group:party,@player]愈合" },
            { "s32", "CTRL-[", "/cast [group:raid,@raid2]愈合;[group:party,@party1]愈合" },
            { "s33", "CTRL-]", "/cast [group:raid,@raid3]愈合;[group:party,@party2]愈合" },
            { "s34", "CTRL-=", "/cast [group:raid,@raid4]愈合;[group:party,@party3]愈合" },
            { "s35", "ALT-NUMPAD1", "/cast [group:raid,@raid5]愈合;[group:party,@party4]愈合" },
            { "s36", "ALT-NUMPAD2", "/cast [group:raid,@raid6]愈合" },
            { "s37", "ALT-NUMPAD3", "/cast [group:raid,@raid7]愈合" },
            { "s38", "ALT-NUMPAD4", "/cast [group:raid,@raid8]愈合" },
            { "s39", "ALT-NUMPAD5", "/cast [group:raid,@raid9]愈合" },
            { "s40", "ALT-NUMPAD6", "/cast [group:raid,@raid10]愈合" },
            { "s41", "ALT-NUMPAD7", "/cast [group:raid,@raid11]愈合" },
            { "s42", "ALT-NUMPAD8", "/cast [group:raid,@raid12]愈合" },
            { "s43", "ALT-NUMPAD9", "/cast [group:raid,@raid13]愈合" },
            { "s44", "ALT-NUMPAD0", "/cast [group:raid,@raid14]愈合" },
            { "s45", "ALT-NUMPADDECIMAL", "/cast [group:raid,@raid15]愈合" },
            { "s46", "ALT-NUMPADPLUS", "/cast [group:raid,@raid16]愈合" },
            { "s47", "ALT-NUMPADMINUS", "/cast [group:raid,@raid17]愈合" },
            { "s48", "ALT-NUMPADMULTIPLY", "/cast [group:raid,@raid18]愈合" },
            { "s49", "ALT-NUMPADDIVIDE", "/cast [group:raid,@raid19]愈合" },
            { "s50", "ALT-F1", "/cast [group:raid,@raid20]愈合" },
            { "s51", "ALT-F2", "/cast [group:raid,@raid21]愈合" },
            { "s52", "ALT-F3", "/cast [group:raid,@raid22]愈合" },
            { "s53", "ALT-F5", "/cast [group:raid,@raid23]愈合" },
            { "s54", "ALT-F6", "/cast [group:raid,@raid24]愈合" },
            { "s55", "ALT-F7", "/cast [group:raid,@raid25]愈合" },
            { "s56", "ALT-F8", "/cast [group:raid,@raid26]愈合" },
            { "s57", "ALT-F9", "/cast [group:raid,@raid27]愈合" },
            { "s58", "ALT-F10", "/cast [group:raid,@raid28]愈合" },
            { "s59", "ALT-F11", "/cast [group:raid,@raid29]愈合" },
            { "s60", "ALT-F12", "/cast [group:raid,@raid30]愈合" },
            { "s61", "ALT-,", "/cast [group:raid,@raid1]生命绽放;[group:party,@player]生命绽放" },
            { "s62", "ALT-.", "/cast [group:raid,@raid2]生命绽放;[group:party,@party1]生命绽放" },
            { "s63", "ALT-/", "/cast [group:raid,@raid3]生命绽放;[group:party,@party2]生命绽放" },
            { "s64", "ALT-;", "/cast [group:raid,@raid4]生命绽放;[group:party,@party3]生命绽放" },
            { "s65", "ALT-'", "/cast [group:raid,@raid5]生命绽放;[group:party,@party4]生命绽放" },
            { "s66", "ALT-[", "/cast [group:raid,@raid6]生命绽放" },
            { "s67", "ALT-]", "/cast [group:raid,@raid7]生命绽放" },
            { "s68", "ALT-=", "/cast [group:raid,@raid8]生命绽放" },
            { "s69", "SHIFT-NUMPAD1", "/cast [group:raid,@raid9]生命绽放" },
            { "s70", "SHIFT-NUMPAD2", "/cast [group:raid,@raid10]生命绽放" },
            { "s71", "SHIFT-NUMPAD3", "/cast [group:raid,@raid11]生命绽放" },
            { "s72", "SHIFT-NUMPAD4", "/cast [group:raid,@raid12]生命绽放" },
            { "s73", "SHIFT-NUMPAD5", "/cast [group:raid,@raid13]生命绽放" },
            { "s74", "SHIFT-NUMPAD6", "/cast [group:raid,@raid14]生命绽放" },
            { "s75", "SHIFT-NUMPAD7", "/cast [group:raid,@raid15]生命绽放" },
            { "s76", "SHIFT-NUMPAD8", "/cast [group:raid,@raid16]生命绽放" },
            { "s77", "SHIFT-NUMPAD9", "/cast [group:raid,@raid17]生命绽放" },
            { "s78", "SHIFT-NUMPAD0", "/cast [group:raid,@raid18]生命绽放" },
            { "s79", "SHIFT-NUMPADDECIMAL", "/cast [group:raid,@raid19]生命绽放" },
            { "s80", "SHIFT-NUMPADPLUS", "/cast [group:raid,@raid20]生命绽放" },
            { "s81", "SHIFT-NUMPADMINUS", "/cast [group:raid,@raid21]生命绽放" },
            { "s82", "SHIFT-NUMPADMULTIPLY", "/cast [group:raid,@raid22]生命绽放" },
            { "s83", "SHIFT-NUMPADDIVIDE", "/cast [group:raid,@raid23]生命绽放" },
            { "s84", "SHIFT-F1", "/cast [group:raid,@raid24]生命绽放" },
            { "s85", "SHIFT-F2", "/cast [group:raid,@raid25]生命绽放" },
            { "s86", "SHIFT-F3", "/cast [group:raid,@raid26]生命绽放" },
            { "s87", "SHIFT-F5", "/cast [group:raid,@raid27]生命绽放" },
            { "s88", "SHIFT-F6", "/cast [group:raid,@raid28]生命绽放" },
            { "s89", "SHIFT-F7", "/cast [group:raid,@raid29]生命绽放" },
            { "s90", "SHIFT-F8", "/cast [group:raid,@raid30]生命绽放" },
            { "s91", "SHIFT-F9", "/cast [group:raid,@raid1]迅捷治愈;[group:party,@player]迅捷治愈" },
            { "s92", "SHIFT-F10", "/cast [group:raid,@raid2]迅捷治愈;[group:party,@party1]迅捷治愈" },
            { "s93", "SHIFT-F11", "/cast [group:raid,@raid3]迅捷治愈;[group:party,@party2]迅捷治愈" },
            { "s94", "SHIFT-F12", "/cast [group:raid,@raid4]迅捷治愈;[group:party,@party3]迅捷治愈" },
            { "s95", "SHIFT-,", "/cast [group:raid,@raid5]迅捷治愈;[group:party,@party4]迅捷治愈" },
            { "s96", "SHIFT-.", "/cast [group:raid,@raid6]迅捷治愈" },
            { "s97", "SHIFT-/", "/cast [group:raid,@raid7]迅捷治愈" },
            { "s98", "SHIFT-;", "/cast [group:raid,@raid8]迅捷治愈" },
            { "s99", "SHIFT-'", "/cast [group:raid,@raid9]迅捷治愈" },
            { "s100", "SHIFT-[", "/cast [group:raid,@raid10]迅捷治愈" },
            { "s101", "SHIFT-]", "/cast [group:raid,@raid11]迅捷治愈" },
            { "s102", "SHIFT-=", "/cast [group:raid,@raid12]迅捷治愈" },
            { "s103", "ALT-CTRL-NUMPAD1", "/cast [group:raid,@raid13]迅捷治愈" },
            { "s104", "ALT-CTRL-NUMPAD2", "/cast [group:raid,@raid14]迅捷治愈" },
            { "s105", "ALT-CTRL-NUMPAD3", "/cast [group:raid,@raid15]迅捷治愈" },
            { "s106", "ALT-CTRL-NUMPAD4", "/cast [group:raid,@raid16]迅捷治愈" },
            { "s107", "ALT-CTRL-NUMPAD5", "/cast [group:raid,@raid17]迅捷治愈" },
            { "s108", "ALT-CTRL-NUMPAD6", "/cast [group:raid,@raid18]迅捷治愈" },
            { "s109", "ALT-CTRL-NUMPAD7", "/cast [group:raid,@raid19]迅捷治愈" },
            { "s110", "ALT-CTRL-NUMPAD8", "/cast [group:raid,@raid20]迅捷治愈" },
            { "s111", "ALT-CTRL-NUMPAD9", "/cast [group:raid,@raid21]迅捷治愈" },
            { "s112", "ALT-CTRL-NUMPAD0", "/cast [group:raid,@raid22]迅捷治愈" },
            { "s113", "ALT-CTRL-NUMPADDECIMAL", "/cast [group:raid,@raid23]迅捷治愈" },
            { "s114", "ALT-CTRL-NUMPADPLUS", "/cast [group:raid,@raid24]迅捷治愈" },
            { "s115", "ALT-CTRL-NUMPADMINUS", "/cast [group:raid,@raid25]迅捷治愈" },
            { "s116", "ALT-CTRL-NUMPADMULTIPLY", "/cast [group:raid,@raid26]迅捷治愈" },
            { "s117", "ALT-CTRL-NUMPADDIVIDE", "/cast [group:raid,@raid27]迅捷治愈" },
            { "s118", "ALT-CTRL-F1", "/cast [group:raid,@raid28]迅捷治愈" },
            { "s119", "ALT-CTRL-F2", "/cast [group:raid,@raid29]迅捷治愈" },
            { "s120", "ALT-CTRL-F3", "/cast [group:raid,@raid30]迅捷治愈" },
            { "s121", "ALT-CTRL-F5", "/cast [group:raid,@raid1]自然之愈;[group:party,@player]自然之愈" },
            { "s122", "ALT-CTRL-F6", "/cast [group:raid,@raid2]自然之愈;[group:party,@party1]自然之愈" },
            { "s123", "ALT-CTRL-F7", "/cast [group:raid,@raid3]自然之愈;[group:party,@party2]自然之愈" },
            { "s124", "ALT-CTRL-F8", "/cast [group:raid,@raid4]自然之愈;[group:party,@party3]自然之愈" },
            { "s125", "ALT-CTRL-F9", "/cast [group:raid,@raid5]自然之愈;[group:party,@party4]自然之愈" },
            { "s126", "ALT-CTRL-F10", "/cast [group:raid,@raid6]自然之愈" },
            { "s127", "ALT-CTRL-F11", "/cast [group:raid,@raid7]自然之愈" },
            { "s128", "ALT-CTRL-F12", "/cast [group:raid,@raid8]自然之愈" },
            { "s129", "ALT-CTRL-,", "/cast [group:raid,@raid9]自然之愈" },
            { "s130", "ALT-CTRL-.", "/cast [group:raid,@raid10]自然之愈" },
            { "s131", "ALT-CTRL-/", "/cast [group:raid,@raid11]自然之愈" },
            { "s132", "ALT-CTRL-;", "/cast [group:raid,@raid12]自然之愈" },
            { "s133", "ALT-CTRL-'", "/cast [group:raid,@raid13]自然之愈" },
            { "s134", "ALT-CTRL-[", "/cast [group:raid,@raid14]自然之愈" },
            { "s135", "ALT-CTRL-]", "/cast [group:raid,@raid15]自然之愈" },
            { "s136", "ALT-CTRL-=", "/cast [group:raid,@raid16]自然之愈" },
            { "s137", "ALT-SHIFT-NUMPAD1", "/cast [group:raid,@raid17]自然之愈" },
            { "s138", "ALT-SHIFT-NUMPAD2", "/cast [group:raid,@raid18]自然之愈" },
            { "s139", "ALT-SHIFT-NUMPAD3", "/cast [group:raid,@raid19]自然之愈" },
            { "s140", "ALT-SHIFT-NUMPAD4", "/cast [group:raid,@raid20]自然之愈" },
            { "s141", "ALT-SHIFT-NUMPAD5", "/cast [group:raid,@raid21]自然之愈" },
            { "s142", "ALT-SHIFT-NUMPAD6", "/cast [group:raid,@raid22]自然之愈" },
            { "s143", "ALT-SHIFT-NUMPAD7", "/cast [group:raid,@raid23]自然之愈" },
            { "s144", "ALT-SHIFT-NUMPAD8", "/cast [group:raid,@raid24]自然之愈" },
            { "s145", "ALT-SHIFT-NUMPAD9", "/cast [group:raid,@raid25]自然之愈" },
            { "s146", "ALT-SHIFT-NUMPAD0", "/cast [group:raid,@raid26]自然之愈" },
            { "s147", "ALT-SHIFT-NUMPADDECIMAL", "/cast [group:raid,@raid27]自然之愈" },
            { "s148", "ALT-SHIFT-NUMPADPLUS", "/cast [group:raid,@raid28]自然之愈" },
            { "s149", "ALT-SHIFT-NUMPADMINUS", "/cast [group:raid,@raid29]自然之愈" },
            { "s150", "ALT-SHIFT-NUMPADMULTIPLY", "/cast [group:raid,@raid30]自然之愈" },
            { "s151", "ALT-SHIFT-NUMPADDIVIDE", "/cast [nostance:2]猎豹形态(变形)" },
            { "s152", "ALT-SHIFT-F1", "/cast [nostance:1]熊形态(变形)" },
            { "s153", "ALT-SHIFT-F2", "/cast [nostance:4]枭兽形态" },
            { "s154", "ALT-SHIFT-F3", "/cast 月火术" },
            { "s155", "ALT-SHIFT-F5", "/cast 树皮术" },
            { "s156", "ALT-SHIFT-F6", "/cast 横扫" },
            { "s157", "ALT-SHIFT-F7", "/cast 潜行" },
            { "s158", "ALT-SHIFT-F8", "/cast 凶猛撕咬" },
            { "s159", "ALT-SHIFT-F9", "/cast 愤怒" },
            { "s160", "ALT-SHIFT-F10", "/cast 割裂" },
            { "s161", "ALT-SHIFT-F11", "/cast 撕碎" },
            { "s162", "ALT-SHIFT-F12", "/cast 斜掠" },
            { "s163", "ALT-SHIFT-,", "/cast 痛击" },
            { "s164", "ALT-SHIFT-.", "/cast 野性印记" },
            { "s165", "ALT-SHIFT-/", "/cast 裂伤" },
            { "s166", "ALT-SHIFT-;", "/cast 野性成长" },
            { "s167", "ALT-SHIFT-'", "/cancelaura [spec:4]猎豹形态\n/cast 万灵之召" },
            { "s168", "ALT-SHIFT-[", "/cast 自然迅捷" },
            { "s169", "ALT-SHIFT-]", "/cast 激活" },
