...
def _run_priest_loop():
    ...
    while True:
        ...
        if spec_name == "戒律":
            ...
            elif spells.get("激活") == 0 and energy_value <= 80 and combat:
            ...
            elif state_dict.get("节能施法") and no_regrowth_lowest_unit is not None and no_regrowth_lowest_pct is not None and no_regrowth_lowest_pct < 90:
            ...
            elif one_rejuv_unit is not None and one_rejuv_pct is not None and one_rejuv_pct < 60:
                _current_step = f"施放 回春术 on {one_rejuv_unit}"
                action_hotkey = get_hotkey(int(one_rejuv_unit), "回春术")
